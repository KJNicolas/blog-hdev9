    ...
    <>
      <div className="min-h-screen bg-blue-800 flex justify-center items-center">
        {profileLoading ? (
          ...
          <div className="h-screen flex overflow-hidden bg-blue-900 text-white ">
            {/* Static sidebar for desktop */}

            <div className="flex flex-col min-w-0 flex-1 overflow-auto ">
              <div className="flex-1 relative z-0 flex overflow-hidden ">
                <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last scrollbar-hide">
                  <article>
                    {/* Profile header */}
                    <div>
                      <div>
                      ...
                      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                          <div className="flex -mt-20">
                            <img
                              className="h-24 w-24 rounded-full mb-20  ring-4 ring-white sm:h-32 sm:w-32"
                              src={profile?.profilePhoto}
                              alt={profile?.firstName}
                            />
                          </div>
                          <div className="mt-4 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                            <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              <h1 className="text-2xl font-bold text-white pt-6 ">
                                {profile?.firstName} {profile?.lastName}
                                <span className="inline-flex items-center m-2 px-6 py-1 rounded-md text-sm mt-4 font-medium bg-red-900 text-gray-400">
                                  {profile?.accountType}
                                </span>
                                {/* Display if verified or not */}
                                {profile?.isAccountVerified ? (
                                  <span className="inline-flex ml- items-center px-6 py-1  rounded-md text-sm font-medium bg-green-600 text-white">
                                    Account Verified
                                  </span>
                                ) : (
                              ...
                              {isLoginUser && (
                                <Link
                                  ...
                                  className="inline-flex justify-center w-48 px-4 py-2 border border-yellow-300 shadow-sm text-sm font-medium rounded-md text-gray-300 bg-white hover:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                >
                                  <UploadIcon
                            ...
                            <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                              ...
                              <>
                                {isLoginUser && (
                                  <Link
                                    ...
                                    className="inline-flex justify-center px-4 py-2 border border-yellow-700 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-blue-900 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                  >
                                    <UserIcon
                                      className="-ml-1 mr-2 h-5 w-5 text-gray-400"
                                      aria-hidden="true"
                                    />
                                    <span className="text-base mr-2  text-bold text-gray-400">Update Profile</span>
                                  </Link>
                                )}
                              </>
                              {/* Send Mail */}
                              <button
                                ...
                                className="inline-flex justify-center bg-blue-900 px-4 py-2 border border-yellow-700 shadow-sm text-sm font-medium rounded-md text-gray-200  hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                              >
                                <MailIcon
                    ...
                    <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                      <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                        <h1 className="text-center text-md border-gray-500 pb-10 py-10 border-b">
                            ...
                            profile?.viewedBy?.map(user => (
                              <li>
                                <Link to={`/profile/${user?._id}`}>
                                  ...
                                  <div className="flex mb-2 pb-10 py-10 items-center space-x-2 lg:space-x-4">
                      ...
                      <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                        <h1 className="text-center text-md border-gray-500 mb-2 pb-10 py-10 border-b-2">

...
const Login = () => {
  ...
  return (
    <>
      <section className="min-h-screen relative py-20 2xl:py-40 bg-blue-900 overflow-hidden">
        <div className="absolute top-0 left-0 lg:bottom-0 h-full lg:h-auto w-full lg:w-4/12 bg-yellow-500 lg:overflow-hidden">
          <img
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-md">
                  {/* Form */}
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-md">
                      ...
                      <input
                        ...
                        className="w-full pr-6 pl-4 py-4 font-bold placeholder-gray-300 rounded-r-md focus:outline-none"
                        type="email"
                    ...
                    <div className="flex items-center pl-6 mb-6 border border-gray-50 bg-white rounded-md">
                      <span className="inline-block pr-3 border-r border-gray-50">
                        <svg
                          className="w-5 h-5"
                          width="20"
                    ...
                    {loading ? (
                      <button
                        disabled
                        className="py-4 w-full bg-gray-500 text-white font-bold rounded-md transition duration-200"
                      >
                        Loading...
                      </button>
                    ) : (
                      <button
                        type="submit"
                        className="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-md transition duration-200"
                      >
                        Login
                      </button>
                    )}

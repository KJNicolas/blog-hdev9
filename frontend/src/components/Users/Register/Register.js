...
const Register = () => {
  ...
  return (
    <section className="relative py-20 2xl:py-40 bg-blue-800 overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white">
                  Create an account and start telling the world about BOOKIT
                </h2>
              </div>
            </div>
                ...
                <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className="flex items-center pl-6 mb-3 bg-white rounded-md">
                    ...
                    <input
                      ...
                      className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-300 rounded-r-md focus:outline-none"
                      type="firstName"
                  ...
                  <div className="flex items-center pl-6 mb-3 bg-white rounded-md">
                    ...
                    <input
                      ...
                      className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-300 rounded-md focus:outline-none"
                      type="password"

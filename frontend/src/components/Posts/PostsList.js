...
export default function PostsList() {
  ...
  return (
    <>
      <section>
        <div className="py-20 bg-blue-900 min-h-screen radius-for-skewed">
            ...
            <div className="mb-16 flex flex-wrap items-center">
              ...
              <div className=" block text-right w-1/2">
                ...
                {/* <button
                  ...
                  className="inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-yellow-500 hover:bg-yellow-700 text-gray-50 font-bold leading-loose transition duration-200"
                >
                  View All Posts
                </button> */}
              </div>
              ...
              <div class="w-full lg:w-3/4 px-3">
                ...
                {appErr || serverErr ? (
                  ...
                  postLists?.map(post => (
                    <div
                      key={post.id}
                      className="flex flex-wrap bg-blue-900 -mx-  lg:mb-6"
                    >
                      <div className="mb-10  w-full lg:w-1/4 ">
                        ...
                        <div className="flex flex-row bg-gray-300  justify-center w-full  items-center ">
                          ...
                          <div className="flex flex-row justify-center items-center ml-4 mr-4 pb-2 pt-1">
                            <div>
                              <EyeIcon className="h-7 w-7  text-orange-400" />
                            </div>
        ...
        <div className="bg-blue-900">
          ...
          <div class="skew bg-blue-800  skew-bottom ml-for-radius">
            <svg
              class="h-8 bg-red-500 md:h-12 lg:h-20 w-full text-gray-900"
              viewBox="0 0 10 10"
              preserveAspectRatio="none"
            >

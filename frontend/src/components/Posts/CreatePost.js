      ...
      <div className="min-h-screen bg-blue-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            <p className="font-medium text-yellow-500 hover:text-indigo-500">
              Share and read the rest of the worlds point of view through blogging
            </p>
          </p>
                  ...
                  >
                    {({ getRootProps, getInputProps }) => (
                      <div className="container">
                        ...
                        >
                          <input {...getInputProps()} />
                          <p className="text-black-900 text-lg cursor-pointer hover:text-gray-500">
